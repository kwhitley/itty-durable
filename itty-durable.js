import { error, json, status, StatusError, Router, withParams, } from 'itty-router';
...
export const createDurable = (options = {}) => {
    ...
    return class IttyDurable {
        constructor(state = {}, env = {}) {
            ...
            this.state.router
                .get('/do/:action/:target', withParams, async (request, env) => {
            ...
            }, proxied.optionallyReturnThis, () => status(204));
            return proxied;
        }
...
//# sourceMappingURL=itty-durable.js.map